...
<!-- ============================================================
     ...
     (Delete everything from the first <script> that declares
      ...
      <script src="chat_send.js"> line — replace with this)
     ============================================================ -->
...
// ── THIS is the ONE variable that tracks who you're chatting with ───────────
let currentChatUser = null;

// ── Open chat panel → load user list ────────────────────────────────────────
...
// ── Click a user in the list → open their conversation ──────────────────────
document.addEventListener('click', e => {
...
// ── SEND BUTTON — reads currentChatUser (same scope, always up to date) ──────
sendBtn.addEventListener('click', () => {
  ...
  .then(data => {
    if (data.status === 'sent') {
      ...
      alert('Cannot send — this user has blocked you or vice versa.');
    } else {
